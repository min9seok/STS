...
public class Ex12 {
	...
	public static void main(String[] args) {
		...
		//The field Time.milisecond is not visible // 원인 접근지정자 설명 
//		t.milisecond = 199;
		
		// 1. 클래스 앞에 붙는 접근지정자 설명 
		// 2. 멤버(필드,메서드,생성자(constructor) 앞에 붙는 접근지정자 설명
		// public 패키지 내외부 어디서나 접근(참조) 가능
		// default 패키지 내부에서만 접근(참조) 가능
		// protected == default + 상속( 패키지 내외부 상관없이 상속 관계 참조가능)
		// private 클래스 내에서만 접근(참조) 가능
		// 3. 범위 public > protectec > default > private
