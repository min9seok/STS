...
public class Ex06 {
	 ...
	 *        java 폴더 > lang 폴더 > System.class 파일
	 *  6) 선언형식
	 *     소스파일의 첫 번째 라인 단 한번 선언
	 *     package 패키지명.패키지명;    
	 *  7) 패키지명은 소문자로 작성
	 *  2. import문
	 *  1) 소스파일에서 다른 패키지의 클래스를 사용하려면 패키지명이 포함된 클래스이름을 사용해야 된다.
	 *  2) 패키지이름 + 클래스이름 = 클래스의 풀네임
	 *      java.io.클래스명
	 *  3) 풀네임 
	 *  	java.lang.System.out.println();
	 *  4) import문 사용해서 미리 풀네임을 명시 import java.lang.System;
	 *  5) import 문 X
	 *  Ctrl + Shift + O
	 *  6)  import java.io.*
	 * 		BufferedReader br;
